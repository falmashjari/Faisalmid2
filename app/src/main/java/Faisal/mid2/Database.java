    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        go1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Database.this,intro.class));
            }
        });
        go3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Database.this,Database2.class));
            }
        });
        ...
        Databaseh dbHelper=new Databaseh(this);
        ...
        select_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (c==null){
                    Toast.makeText(Database.this,"No data to read.",Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        del_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Database.this,"Successfully deleted first row",Toast.LENGTH_SHORT).show();
            }
        });
